#=
    ...
    Instala algunos paquetes externos necesarios para realizar
    inferencia estadística, mediante un ciclo. También podrían
    instalarse uno por uno desde el modo paquete en la terminal mediante
